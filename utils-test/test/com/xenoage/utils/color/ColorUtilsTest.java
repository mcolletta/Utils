...
public class ColorUtilsTest {
	...
	@Test public void toHTMLColorTest() {
		...
		assertEquals("#ffffff", toHTMLColor(Color.color(255, 255, 255, 200)));
		assertEquals("#ff0080", toHTMLColor(Color.color(255, 0, 128, 100)));
		assertEquals("#010203", toHTMLColor(Color.color(1, 2, 3, 100)));
	}
